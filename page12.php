                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="mbr-text py-5 mbr-fonts-style display-7">
                                    Item list and some approximation of demand &nbsp;1</p>
                            </div>
                        </div>
                    </div>
                    <div id="tab2" class="tab-pane" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="mbr-text py-5 mbr-fonts-style display-7">
                                    Item list and some approximation of demand &nbsp;2</p>
                            </div>
                        </div>
                    </div>
                    <div id="tab3" class="tab-pane" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="mbr-text py-5 mbr-fonts-style display-7">Item list and some approximation of demand &nbsp;3</p>
                            </div>
                        </div>
                    </div>
...
?>
<!-- Code for form............ -->
<section class="mbr-section info1 cid-qvYsoUPTbT" id="info1-15" data-rv-view="409">
  <center>
  <div class="container container-table">
    <form action = "page1.php" method = "post">
      <h3 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Name Of Item</h3> 
      <input type = "text" name = "itemName" ><br><br>
      <h3 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Category Of Item</h3> 
      <input type = "text" name = "itemCat" ><br><br>
      <h3 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Quantity Of Item</h3> 
      <input type = "text" name = "itemQuant"><br><br>
      <h3 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Price pre Item</h3> 
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="media-container-column col-12 col-lg-3 col-md-4">
                <div class="mbr-section-btn align-right py-4"><a class="btn btn-primary display-4" href="page4.html">Analyse market</a></div>
            </div>
        </div>
    </div>
</section>
